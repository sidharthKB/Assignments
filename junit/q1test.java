...
public class q1test {
    ...
    void findMinMax2() {
        assertAll(
                () -> assertEquals("Min is 0 Max is 34",q1.findMinMax2(new int[]{0, 1, 2, 34, 5, 6})),
                () -> assertEquals("Min is 1 Max is 10",q1.findMinMax2(new int[]{1, 2, 10, 5, 6})),
                () -> assertEquals("Min is 2 Max is 100",q1.findMinMax2(new int[]{ 100, 2, 34, 5, 6})));
    }
}
